...
// Add a tenth og a second to timePlayed
function addTime() {
  timePlayed += 0.1;
  checkTime();
}

// Start timer when game page is clicekd
function startTimer() {
  // Reset times
  timePlayed = 0;
  penaltyTime = 0;
...
// Navigate drom Splash page to Countdown Page
...
// Form tha decides amount of questions
...
startForm.addEventListener('click', () => {
  radioContainers.forEach((radioEl) => {
    ...
    // Add it back if raio input is checked
